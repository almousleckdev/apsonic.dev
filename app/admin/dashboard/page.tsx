...
import { AdminStatCard, AdminContentCard } from '@/components/admin/AdminShared';
...
const recentActivityCols = [
    {
        header: '操作', accessor: (item: any) => (
            <div className="flex items-center gap-3">
                <div className={`w-2 h-2 rounded-full ${item.type === 'create' ? 'bg-green-500' : 'bg-blue-500'}`} />
...
const mockActivity = [
    { id: 1, action: '发布新闻', target: '第137届广交会', user: '管理员', date: '2小时前', type: 'create' },
    { id: 2, action: '更新产品', target: 'AP125-30', user: '管理员', date: '5小时前', type: 'update' },
    { id: 3, action: '删除分类', target: '过时配件', user: '系统', date: '1天前', type: 'delete' },
    { id: 4, action: '新消息', target: '销售咨询 #42', user: '公众', date: '1天前', type: 'create' },
];
                    ...
                    <AdminContentCard title="系统状态">
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-xs font-bold text-brand-green px-2 py-0.5 rounded bg-brand-green/10">稳定</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-500">存储</span>
                                <span className="text-xs font-bold text-gray-700 px-2 py-0.5 rounded bg-gray-100">已使用84%</span>
                            </div>
