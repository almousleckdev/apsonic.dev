...
const mockCategories = [
    ...
    { id: 4, name: 'Tricycle', slug: 'tricycle', image: '/images/products/tricycle.png', count: 45 },
    { id: 5, name: 'Spare Parts', slug: 'spare-parts', image: '/images/products/parts.png', count: 1205 },
];
        ...
        <AdminLayout>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Manage catalogs and hierarchical groupings</p>
                </div>
                <Button
