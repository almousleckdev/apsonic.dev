      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-black/5 border border-black/10 px-4 py-1.5 rounded-full text-gray-900 text-sm font-bold mb-6"
          >
          ...
          >
            Join the elite network of certified Apsonic technicians. Our
            tier-based training program equips you with the skills to diagnose,
            repair, and maintain the next generation of African mobility.
          </motion.p>
        </div>
      </div>
    </div>
