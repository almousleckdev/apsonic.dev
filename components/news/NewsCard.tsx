  ...
  if (variant === "overlay") {
    return (
      <motion.div
        ...
        className={cn(
          "relative h-[400px] rounded-2xl overflow-hidden group border border-gray-100 cursor-pointer shadow-lg shadow-gray-200",
          className,
        )}
      >
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex flex-col">
              <span className="text-[11px] font-bold text-gray-900 leading-none mb-0.5">
