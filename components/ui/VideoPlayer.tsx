...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
    ...
    return (
        <div className={cn("relative group rounded-2xl overflow-hidden bg-gray-900 shadow-lg", className)}>
                ...
                {!isPlaying ? (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-black/30 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                            <div className="w-16 h-16 rounded-full bg-brand-green text-white flex items-center justify-center shadow-2xl transition-transform duration-300 group-hover:scale-110">
                        ...
                        {description && (
                            <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                                ...
                                <p className="text-gray-300 text-sm line-clamp-1">{description}</p>
                            </div>
                        )}
                    </motion.div>
                ) : (
